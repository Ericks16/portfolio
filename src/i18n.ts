...
export const strings = {
  es: {
    ...
    contact: {
      ...
      pending: "Activando el formulario por primera vez… vuelve a intentar en un momento 🙌",
      fallback: "Toca el botón para enviarme el mensaje por correo 👇",
  ...
  en: {
    ...
    contact: {
      ...
      pending: "Activating the form for the first time… please try again in a moment 🙌",
      fallback: "Tap the button to send me the message via email 👇",
      fallbackBtn: "SEND VIA EMAIL",
      or: "or find me at",
    },
